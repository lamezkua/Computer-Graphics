...
Hours spent on extra credit (approx.): 0 hrs.
...
# and leave your 'attempt' code in place (commented out if necessary) so we can see it.
 ...
 R3 Trapezoid integrator (2p): done
      R4 Pendulum system (2p): done
         R5 Cloth system (3p): not-completed (I didn't have enough time to implement the shear and flexion springs)
...
# Did you collaborate with anyone in the class? I asked different classmated about how to implement the exercises.

(Did you help others? Did others help you? Let us know who you talked to, and what sort of help you gave or received.)

# Any other comments you'd like to share about the assignment or the course so far? Hard.
...
Very interesting. Very hard to debug the code. Similar examples and an exercise session where we could go through similar implementations would be of great help.
