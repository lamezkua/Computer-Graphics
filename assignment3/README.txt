...
Hours spent on requirements (approx.): 56 hrs.
...
# Did you collaborate with anyone in the class? I asked other classmates about different doubts of the problems.
...
The notation/terms of the assignment and the lectures slides is not completely aligned thus it is difficult to understand and relate the problems/code comments with the slides.
