...
Hours spent on requirements (approx.):80 hrs.
...
The  exercises  have been difficult for me because  it has been difficult to follow them against the theory: the notation is different, the theory is found in different lecture slides (if there  is any), 
it is not so clear what exactly we have to do. At least  this is part of the objective of the course (to make things harder), it would be very good to correct these issues.
